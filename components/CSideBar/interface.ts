...
export type MenuItemConfig<
  MenuItemData extends Record<string, any> = Record<string, unknown>,
  SubMenuData extends Record<string, any> = Record<string, unknown>,
  GroupMenuData extends Record<string, any> = Record<string, unknown>,
> =
  | CustomProps
  | GroupMenuItemProps<GroupMenuData>
  | MenuItemProps<MenuItemData>
  | MenuSubMenuProps<SubMenuData>
  | CategoryTitleProps;
 ...
 */
export interface GroupMenuItemProps<T extends Record<string, any> = Record<string, unknown>>
  extends Omit<MenuItemGroupProps, 'children'>,
    BaseMenu {
  type: 'group';
  key: string;
  data?: T;
 ...
 */
export interface MenuItemProps<T extends Record<string, any> = Record<string, unknown>>
  extends Omit<ArcoMenuItemProps, 'children'> {
  type?: 'menu';
  path?: string;
  /**
   * @zh 菜单的名称文本
  ...
  // TODO 子菜单全部hidden了，submenu 和group 应该hidden
  /** 控制该条菜单是否展示。 */
  hidden?: boolean;
 ...
 */
export interface MenuSubMenuProps<T extends Record<string, any> = Record<string, unknown>>
  extends Omit<ArcoMenuSubMenuProps, 'children'>,
    BaseMenu {
  type: 'sub-menu';
  /** 菜单title前面的icon */
  icon?: ReactNode;
...
export interface CSideBarProps extends Omit<React.HTMLAttributes<HTMLElement>, 'children' | 'title'> {
  ...
  arcoMenuProps?: Omit<
    MenuProps,
    'defaultOpenKeys' | 'defaultCollapse' | 'defaultSelectedKeys' | 'accordion' | 'onClickMenuItem'
  >;
   ...
   */
  renderMenuItem?: (
    wrapperProps: { children?: React.ReactNode; className?: string },
...
export interface UseSideBarWidthControlParams
  extends Pick<CSideBarHooksProps, 'controlledRefs' | 'widthControllerRef' | 'widthControl'> {
