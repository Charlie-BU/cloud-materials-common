...
export enum ExportDataRangeType {
  all = 'all',
...
export interface ExportDataBtnProps {
   ...
   * 选中导出范围后的提示文案
   */
  getExportRangeDesc?: (options: { curChosenType: ExportDataRangeType; table: Table }) => React.ReactNode;
  /**
...
export const ExportDataBtn: FC<ToolbarItemRenderProps & ExportDataBtnProps> = props => {
  return <ExportData table={props.table} options={props} />;
};
