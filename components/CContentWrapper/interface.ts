 ...
 */
export interface CContentWrapperProps
  extends Omit<React.HTMLAttributes<HTMLDivElement>, 'title' | 'className' | 'children'> {
  /** 标题（设置为 null 时，不显示标题） */
  title?: ReactNode;
  /** 标题的提示框*/
  tooltip?: ReactNode;
   ...
   */
  renderContent?: ((content: { header: React.ReactNode; body: React.ReactNode }) => React.ReactNode) | false;
  /** 内容组件 */
  content?: ReactNode;
  children?: ReactNode;
