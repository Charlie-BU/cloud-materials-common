...
import { IconEdit, IconClose, IconMessage } from '@arco-design/web-react/icon';
import { BaseItem } from '../FormItem';
...
export var Editable = observer(function (props) {
  ...
  var renderEditHelper = function renderEditHelper() {
    if (editable) return;
    return /*#__PURE__*/React.createElement(BaseItem, _Object$assign({}, props, itemProps), pattern === 'editable' && /*#__PURE__*/React.createElement(IconEdit, {
      className: "".concat(prefixCls, "-edit-btn")
    }), pattern !== 'editable' && /*#__PURE__*/React.createElement(IconMessage, {
      className: "".concat(prefixCls, "-edit-btn")
    }));
  };
  var renderCloseHelper = function renderCloseHelper() {
    if (!editable) return;
    return /*#__PURE__*/React.createElement(BaseItem, _Object$assign({}, props), /*#__PURE__*/React.createElement(IconClose, {
  ...
  }, /*#__PURE__*/React.createElement(BaseItem, _Object$assign({}, props, itemProps), props.children), renderEditHelper(), renderCloseHelper()));
});
Editable.Popover = observer(function (props) {
  ...
  return /*#__PURE__*/React.createElement(Popover, _Object$assign({}, props, {
  ...
  }, props.title || field.title), pattern === 'editable' && /*#__PURE__*/React.createElement(IconEdit, {
    className: "".concat(prefixCls, "-edit-btn")
  }), pattern !== 'editable' && /*#__PURE__*/React.createElement(IconMessage, {
    className: "".concat(prefixCls, "-edit-btn")
  })))));
