...
var AsyncDataSourceEffect = function AsyncDataSourceEffect(pattern, service) {
  onFieldReact(pattern, function (field) {
    ...
    var _field = field;
    _field.loading = true;
    service(_field).then((_a = action.bound) === null || _a === void 0 ? void 0 : _a.call(action, function (data) {
...
export default (function () {
  return /*#__PURE__*/React.createElement(FormProvider, {
    form: form
  }, /*#__PURE__*/React.createElement(SchemaField, null, /*#__PURE__*/React.createElement(SchemaField.Number, {
    name: "linkage",
    title: "\u8054\u52A8\u9009\u62E9\u6846",
