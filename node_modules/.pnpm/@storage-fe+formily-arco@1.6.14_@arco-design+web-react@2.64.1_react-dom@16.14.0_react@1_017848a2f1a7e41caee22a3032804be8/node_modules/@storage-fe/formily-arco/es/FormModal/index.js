...
var isModalTitle = function isModalTitle(props) {
  return isNum(props) || isStr(props) || isBool(props) || /*#__PURE__*/React.isValidElement(props);
};
...
export function FormModal(title, id, renderer) {
  var _this = this;
  if (isFn(id) || /*#__PURE__*/React.isValidElement(id)) {
    renderer = id;
    id = 'form-modal';
  }
  var env = {
  ...
  var modal = _Object$assign(_Object$assign({}, props), {
  ...
  var ModalContent = observer(function () {
    return /*#__PURE__*/React.createElement(Fragment, null, isFn(renderer) ? renderer(env.form) : renderer);
  });
  var renderModal = function renderModal() {
    ...
    return /*#__PURE__*/React.createElement(Observer, null, function () {
      ...
      return /*#__PURE__*/React.createElement(FormProvider, {
        form: env.form
      }, /*#__PURE__*/React.createElement(Modal, _Object$assign({}, modal, {
        visible: visible,
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 2:
                env.promise = new _Promise(function (resolve, reject) {
                      ...
                      while (1) {
                        switch (_context4.prev = _context4.next) {
                          case 0:
                            _context4.prev = 0;
                            _context4.next = 3;
                            return loading(modal.loadingText, function () {
                                    ...
                                    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                                      while (1) {
                                        switch (_context2.prev = _context2.next) {
                                          case 0:
                                            _context2.next = 2;
                                            return applyMiddleware(env.form, env.confirmMiddlewares);
                                          case 2:
                                            resolve(toJS((_b = env.form) === null || _b === void 0 ? void 0 : _valuesInstanceProperty(_b)));
                                            formModal.close();
                                          case 4:
                                          case "end":
...
var FooterLeft = function FooterLeft(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ref: ref
  }, footer && /*#__PURE__*/createPortal(props.children, footer));
};
