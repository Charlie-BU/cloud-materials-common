...
var _webReact = require("@arco-design/web-react");
...
var isModalTitle = function isModalTitle(props) {
  return (0, _shared.isNum)(props) || (0, _shared.isStr)(props) || (0, _shared.isBool)(props) || /*#__PURE__*/_react.default.isValidElement(props);
};
var getModelProps = function getModelProps(props) {
...
function FormModal(title, id, renderer) {
  var _this = this;
  if ((0, _shared.isFn)(id) || /*#__PURE__*/_react.default.isValidElement(id)) {
    renderer = id;
    id = 'form-modal';
  }
  var env = {
  ...
  var root = (0, _builtins__.createPortalRoot)(env.host, id);
  var props = getModelProps(title);
  var modal = (0, _assign.default)((0, _assign.default)({}, props), {
  ...
  var ModalContent = (0, _react2.observer)(function () {
    return /*#__PURE__*/_react.default.createElement(_react.Fragment, null, (0, _shared.isFn)(renderer) ? renderer(env.form) : renderer);
  });
  var renderModal = function renderModal() {
    ...
    return /*#__PURE__*/_react.default.createElement(_react2.Observer, null, function () {
      var _a;
      return /*#__PURE__*/_react.default.createElement(_react2.FormProvider, {
        form: env.form
      }, /*#__PURE__*/_react.default.createElement(_webReact.Modal, (0, _assign.default)({}, modal, {
        visible: visible,
        confirmLoading: (_a = env === null || env === void 0 ? void 0 : env.form) === null || _a === void 0 ? void 0 : _a.submitting,
      ...
      }), /*#__PURE__*/_react.default.createElement(ModalContent, null)));
    });
  };
  document.body.appendChild(env.host);
  var formModal = {
    forOpen: function forOpen(middleware) {
      if ((0, _shared.isFn)(middleware)) {
        env.openMiddlewares.push(middleware);
      }
      return formModal;
    },
    forConfirm: function forConfirm(middleware) {
      if ((0, _shared.isFn)(middleware)) {
        env.confirmMiddlewares.push(middleware);
      }
      return formModal;
    },
    forCancel: function forCancel(middleware) {
      if ((0, _shared.isFn)(middleware)) {
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                return _context5.abrupt("return", env.promise);
              case 2:
                env.promise = new _promise.default(function (resolve, reject) {
                      ...
                      while (1) {
                        switch (_context4.prev = _context4.next) {
                          case 0:
                            _context4.prev = 0;
                            _context4.next = 3;
                            return (0, _builtins__.loading)(modal.loadingText, function () {
                              return (0, _shared.applyMiddleware)(props, env.openMiddlewares);
                            });
                          case 3:
                            props = _context4.sent;
                            env.form = env.form || (0, _core.createForm)(props);
                            _context4.next = 10;
                            break;
                          case 7:
                            _context4.prev = 7;
                          ...
                          case 10:
                            root.render(function () {
                              return renderModal(true, function () {
                                var _a;
                                (_a = env.form) === null || _a === void 0 ? void 0 : _a.submit(function () {
                                    ...
                                    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                                      while (1) {
                                        switch (_context2.prev = _context2.next) {
                                          case 0:
                                            _context2.next = 2;
                                            return (0, _shared.applyMiddleware)(env.form, env.confirmMiddlewares);
                                          case 2:
                                            resolve((0, _reactive.toJS)((_b = env.form) === null || _b === void 0 ? void 0 : (0, _values.default)(_b)));
                                            formModal.close();
                                          case 4:
                                          case "end":
                                    ...
                                    while (1) {
                                      switch (_context3.prev = _context3.next) {
                                        case 0:
                                          _context3.next = 2;
                                          return (0, _builtins__.loading)(modal.loadingText, function () {
                                            return (0, _shared.applyMiddleware)(env.form, env.cancelMiddlewares);
                                          });
                                        case 2:
                                          formModal.close();
                                        case 3:
...
// const ModalFooter: ReactFC = props => {
...
//         footerRef.current = content.querySelector<HTMLDivElement>(`.${prefixCls}-footer`) as unknown as HTMLDivElement;
//         if (!footerRef.current) {
...
//   return <div ref={ref}>{footer && createPortal(props.children, footer)}</div>;
// };
var FooterLeft = function FooterLeft(props) {
  ...
  var prefixCls = (0, _builtins__.usePrefixCls)('modal');
  (0, _react.useLayoutEffect)(function () {
    ...
    if (content) {
      if (!footerRef.current) {
        ...
        footerRef.current.classList.add("arco-formily-modal-footer");
        var buttonContainer = document.createElement('div');
        buttonContainer.classList.add("arco-formily-modal-footer-button-wrapper");
        var cancelButton = footerRef.current.querySelector(".arco-btn-secondary");
        var confirmButton = footerRef.current.querySelector(".arco-btn-primary");
        if (cancelButton) {
        ...
        footerRef.current.appendChild(buttonContainer);
      }
    }
    setFooter(footerRef.current);
  });
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ref: ref
  }, footer && /*#__PURE__*/(0, _reactDom.createPortal)(props.children, footer));
};
// FormModal.Footer = ModalFooter;
FormModal.FooterLeft = FooterLeft;
FormModal.Portal = (0, _builtins__.createPortalProvider)('form-modal');
