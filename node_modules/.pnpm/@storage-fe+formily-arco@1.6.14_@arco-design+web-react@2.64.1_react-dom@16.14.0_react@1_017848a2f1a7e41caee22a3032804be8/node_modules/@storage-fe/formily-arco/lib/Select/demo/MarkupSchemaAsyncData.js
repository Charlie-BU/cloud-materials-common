...
var _formilyArco = require("@storage-fe/formily-arco");
...
var refFetchId = (0, _now.default)();
var debouncedFetchUser = (0, _lodash.debounce)(function (_, callback) {
  refFetchId = (0, _now.default)();
  var fetchId = refFetchId;
  fetch('https://randomuser.me/api/?results=5').then(function (response) {
    return response.json();
  }).then(function (body) {
    if (refFetchId === fetchId) {
      var _context;
      var options = (0, _map.default)(_context = body.results).call(_context, function (user) {
        var _context2;
        return {
          ...
          }, /*#__PURE__*/_react.default.createElement(_webReact.Avatar, {
            size: 24,
            style: {
              marginLeft: 6,
              marginRight: 12
          ...
          })), (0, _concat.default)(_context2 = "".concat(user.name.first, " ")).call(_context2, user.name.last)),
          value: user.email
        };
      });
      callback(options);
...
var SchemaField = (0, _react2.createSchemaField)({
  components: {
    Select: _formilyArco.Select,
    FormItem: _formilyArco.FormItem
  }
});
var AsyncDataSourceEffect = function AsyncDataSourceEffect(pattern, service) {
  var keyword = _reactive.observable.ref('');
  (0, _core.onFieldInit)(pattern, function (field) {
  ...
  (0, _core.onFieldReact)(pattern, function (field) {
    var _a;
    var _field = field;
    _field.loading = true;
    service({
    ...
    }).then((_a = _reactive.action.bound) === null || _a === void 0 ? void 0 : _a.call(_reactive.action, function (data) {
      _field.dataSource = data;
      _field.loading = false;
    }));
  });
};
var form = (0, _core.createForm)({
  effects: function effects() {
    AsyncDataSourceEffect('select', function (_ref) {
...
var _default = function _default() {
  return /*#__PURE__*/_react.default.createElement(_react2.FormProvider, {
    form: form
  }, /*#__PURE__*/_react.default.createElement(SchemaField, null, /*#__PURE__*/_react.default.createElement(SchemaField.String, {
    name: "select",
    title: "\u5F02\u6B65\u641C\u7D22\u9009\u62E9\u6846",
  ...
  })), /*#__PURE__*/_react.default.createElement(_formilyArco.FormButtonGroup, null, /*#__PURE__*/_react.default.createElement(_formilyArco.Submit, {
