...
_forEachInstanceProperty(_context = _Object$keys(_usePrefixCls)).call(_context, function (key) {
...
_forEachInstanceProperty(_context2 = _Object$keys(_useClickAway)).call(_context2, function (key) {
  if (key === "default" || key === "__esModule") return;
