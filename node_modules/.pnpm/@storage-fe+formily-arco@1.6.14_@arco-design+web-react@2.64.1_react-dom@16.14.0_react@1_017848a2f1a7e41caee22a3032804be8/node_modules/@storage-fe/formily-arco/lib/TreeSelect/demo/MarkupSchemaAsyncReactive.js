...
var SchemaField = (0, _react2.createSchemaField)({
  components: {
    ...
    TreeSelect: _formilyArco.TreeSelect,
...
var AsyncDataSourceEffect = function AsyncDataSourceEffect(pattern, service) {
  (0, _core.onFieldReact)(pattern, function (field) {
    var _a;
    field.loading = true;
    service(field).then((_a = _reactive.action.bound) === null || _a === void 0 ? void 0 : _a.call(_reactive.action, function (data) {
...
var form = (0, _core.createForm)({
  effects: function effects() {
    AsyncDataSourceEffect('select', function (field) {
...
var _default = function _default() {
  return /*#__PURE__*/_react.default.createElement(_react2.FormProvider, {
    form: form
  }, /*#__PURE__*/_react.default.createElement(SchemaField, null, /*#__PURE__*/_react.default.createElement(SchemaField.Number, {
    name: "linkage",
    title: "\u8054\u52A8\u9009\u62E9\u6846",
  ...
  }), /*#__PURE__*/_react.default.createElement(SchemaField.String, {
    name: "select",
    title: "\u5F02\u6B65\u9009\u62E9\u6846",
    "x-decorator": "FormItem",
