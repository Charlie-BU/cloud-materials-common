...
exports.default = exports.Editable = void 0;
...
var _icon = require("@arco-design/web-react/icon");
...
var useEditable = function useEditable() {
  ...
  return [field.pattern === 'editable', function (payload) {
    if (pattern !== 'editable') return;
    field.setPattern(payload ? 'editable' : 'readPretty');
  }];
};
var useFormItemProps = function useFormItemProps() {
  var field = (0, _react2.useField)();
...
var Editable = (0, _react2.observer)(function (props) {
  var _useEditable = useEditable(),
    _useEditable2 = (0, _slicedToArray2.default)(_useEditable, 2),
    editable = _useEditable2[0],
    setEditable = _useEditable2[1];
  var pattern = useParentPattern();
  var itemProps = useFormItemProps();
  var field = (0, _react2.useField)();
  var basePrefixCls = (0, _builtins__.usePrefixCls)();
  var prefixCls = (0, _builtins__.usePrefixCls)('formily-editable');
  ...
  var renderEditHelper = function renderEditHelper() {
    if (editable) return;
    return /*#__PURE__*/_react.default.createElement(_FormItem.BaseItem, (0, _assign.default)({}, props, itemProps), pattern === 'editable' && /*#__PURE__*/_react.default.createElement(_icon.IconEdit, {
      className: "".concat(prefixCls, "-edit-btn")
    }), pattern !== 'editable' && /*#__PURE__*/_react.default.createElement(_icon.IconMessage, {
      className: "".concat(prefixCls, "-edit-btn")
    }));
  };
  var renderCloseHelper = function renderCloseHelper() {
    if (!editable) return;
    return /*#__PURE__*/_react.default.createElement(_FormItem.BaseItem, (0, _assign.default)({}, props), /*#__PURE__*/_react.default.createElement(_icon.IconClose, {
  ...
  var onClick = function onClick(e) {
    var _a;
    var target = e.target;
    var close = (_a = innerRef.current) === null || _a === void 0 ? void 0 : _a.querySelector(".".concat(prefixCls, "-close-btn"));
  ...
  }, /*#__PURE__*/_react.default.createElement(_FormItem.BaseItem, (0, _assign.default)({}, props, itemProps), props.children), renderEditHelper(), renderCloseHelper()));
});
exports.Editable = Editable;
Editable.Popover = (0, _react2.observer)(function (props) {
  var field = (0, _react2.useField)();
  var pattern = useParentPattern();
  ...
  return /*#__PURE__*/_react.default.createElement(_webReact.Popover, (0, _assign.default)({}, props, {
  ...
  }, /*#__PURE__*/_react.default.createElement(_FormItem.BaseItem, {
    className: "".concat(prefixCls, "-trigger")
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "".concat(prefixCls, "-content")
  }, /*#__PURE__*/_react.default.createElement("span", {
    className: "".concat(prefixCls, "-preview")
  }, props.title || field.title), pattern === 'editable' && /*#__PURE__*/_react.default.createElement(_icon.IconEdit, {
    className: "".concat(prefixCls, "-edit-btn")
  }), pattern !== 'editable' && /*#__PURE__*/_react.default.createElement(_icon.IconMessage, {
    className: "".concat(prefixCls, "-edit-btn")
  })))));
