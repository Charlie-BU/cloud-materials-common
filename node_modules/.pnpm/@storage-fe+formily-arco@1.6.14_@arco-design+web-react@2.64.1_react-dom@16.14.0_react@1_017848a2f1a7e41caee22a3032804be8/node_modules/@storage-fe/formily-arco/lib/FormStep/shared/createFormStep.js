...
var createFormStep = function createFormStep() {
  var defaultCurrent = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
  var env = (0, _reactive.define)({
    form: undefined,
    mode: undefined,
    steps: []
  }, {
    form: _reactive.observable.ref,
    steps: _reactive.observable.shallow,
    mode: _reactive.observable.ref
  });
  var setDisplay = _reactive.action.bound(function (target) {
    var _a, _b;
    var currentStep = (_a = env.steps) === null || _a === void 0 ? void 0 : _a[target];
    (_b = env.steps) === null || _b === void 0 ? void 0 : (0, _forEach.default)(_b).call(_b, function (_ref) {
      var name = _ref.name;
      var _a;
      (_a = env.form) === null || _a === void 0 ? void 0 : _a.query(name).take(function (field) {
  ...
  // @ts-ignore
  var formStep = (0, _reactive.model)({
    connect: function connect(options) {
      ...
      if (!options.steps) {
        console.warn('No steps analyzed on the FormStep components, you can use StepPane Component or SchemaField to be the FormStep Component children');
      }
    ...
    setCurrent: function setCurrent(key) {
      ...
      (_a = env.onStepChange) === null || _a === void 0 ? void 0 : _a.call(env, key, formStep);
    },
    get allowNext() {
    ...
    nexting: false,
    setNexting: function setNexting(flag) {
      formStep.nexting = flag;
    },
    backing: false,
    setBacking: function setBacking(flag) {
      formStep.backing = flag;
    },
    next: function next() {
      var _a, _b, _c, _d;
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var target, canGoNext;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                target = formStep.current + 1;
                _context.next = 6;
                return (_a = env.beforeStepChange) === null || _a === void 0 ? void 0 : _a.call(env, formStep, target);
              case 6:
                _context.t1 = _b = _context.sent;
              ...
              case 14:
                _context.t2 = true;
              case 15:
                canGoNext = _context.t2;
                _context.t3 = canGoNext;
                if (!_context.t3) {
                  _context.next = 20;
                  break;
                }
                _context.next = 20;
                return (_c = env.form) === null || _c === void 0 ? void 0 : _c.validate();
              case 20:
                if (canGoNext && ((_d = env.form) === null || _d === void 0 ? void 0 : _d.valid)) {
              ...
              case 24:
                ...
                formStep.setNexting(false);
                console.error('next', _context.t4);
              case 28:
              case "end":
    ...
    nextBySkipValidate: function nextBySkipValidate() {
      var _a, _b;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return (_a = env.beforeStepChange) === null || _a === void 0 ? void 0 : _a.call(env, formStep, target);
              case 5:
                _context2.t1 = _b = _context2.sent;
              ...
              case 18:
                ...
                console.error('nextBySkipValidate', _context2.t3);
              case 21:
              case "end":
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 20:
                ...
                formStep.setBacking(false);
                console.error('back', _context3.t3);
              case 24:
              case "end":
    ...
    submit: function submit(onSubmit) {
      var _a, _b;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 5:
                ...
                console.error('表单校验错误', _context4.t0);
              case 8:
              case "end":
  ...
  return (0, _reactive.markRaw)(formStep);
};
exports.createFormStep = createFormStep;