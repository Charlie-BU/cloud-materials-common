...
const FormGridContext = React.createContext<Grid<HTMLElement>>({} as Grid<HTMLElement>);
...
export const createFormGrid = (props: IFormGridProps) => markRaw(new Grid(props));
...
export const FormGrid: ComposedFormGrid = observer(
  ({ children, className, style, ...props }: React.PropsWithChildren<IFormGridProps>) => {
    ...
    useLayoutEffect(() => grid.connect(ref.current as HTMLDivElement), [grid]);
