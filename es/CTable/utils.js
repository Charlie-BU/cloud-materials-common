export var TableFontSize = {
    CN: '12px',
    US: '14px',
};
var GLOBAL_FONT_SIZE = TableFontSize.CN;
/**
 * @description 支持bytePlus环境下英文大小为14px
 * @param fontSize String
 */
export var setGlobalFontSize = function (fontSize) {
    GLOBAL_FONT_SIZE = fontSize;
};
export function filterDataKey(str) {
    var _a, _b;
    // str 可能不是字符，避免报错
...
/** 对空值做些文本的兜底显示 */
export function fallbackText(value) {
...
export function tryToNumber(numberString) {
