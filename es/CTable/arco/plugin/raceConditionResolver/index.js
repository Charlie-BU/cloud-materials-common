...
var RaceConditionResolver = /** @class */ (function () {
    function RaceConditionResolver() {
        ...
        var memoFetcher = function () {
            ...
            return (_a = _this.fetcher) === null || _a === void 0 ? void 0 : _a.call.apply(_a, __spreadArray([_this], __read(args), false));
        };
    ...
    RaceConditionResolver.prototype.wrapFetcher = function (args) {
        var _a = args.taskPriority, taskPriority = _a === void 0 ? TaskPriority.HIGH : _a, restArgs = __rest(args, ["taskPriority"]);
