 ...
 * @returns
 */
export var formatUrlQueryConfig = function (config) {
    if (config === null || config === void 0 ? void 0 : config.syncWithUrlQuery) {
        ...
        var getCurrentStatusFromUrl_1 = function () {
            var urlQuery = helper.getUrlQuery(getQueryOptions_1 === null || getQueryOptions_1 === void 0 ? void 0 : getQueryOptions_1.parseOptions);
        ...
        return __assign(__assign({}, config), { effects: function (options) {
                var _a;
                 ...
                 */
                effects.onTableUpdateDataEnd(function (_a) {
                    var _b;
                    var table = _a.table;
                    var customStatus = {};
                    if (status_1.includes(TableStatusKeys.toolbarValues)) {
                        customStatus.toolbarValues = (_b = table.toolbar) === null || _b === void 0 ? void 0 : _b.filterValues;
                    }
                    if (status_1.includes(TableStatusKeys.pageSize)) {
                        customStatus.pageSize = table.pageSize;
                    }
                    if (status_1.includes(TableStatusKeys.currentPage)) {
                        customStatus.currentPage = table.currentPage;
                    }
                    if (status_1.includes(TableStatusKeys.columnFilterValues)) {
                        customStatus.columnFilterValues = table.columnFilterValues;
                    }
                    if (status_1.includes(TableStatusKeys.sorterValues)) {
                    ...
                    if (!isEqual(customStatus, currentStatus)) {
                        helper.setUrlQuery(formatSetQuery_1(table, customStatus), commonSetOptions_1);
                    }
                });
