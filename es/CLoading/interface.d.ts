...
export type CResultStatus = 'no-data' | 'no-data-simple' | 'no-data-gray' | 'no-permission' | 'no-permission-simple' | 'no-permission-gray' | 'no-search-result' | 'no-search-result-simple' | 'no-search-result-gray' | 'no-content' | 'no-content-simple' | 'no-content-gray' | 'network-error' | 'network-error-simple' | 'network-error-gray' | 'no-picture' | 'no-picture-gray' | 'no-chart' | 'no-chart-gray' | 'error-type' | 'error-type-simple' | 'error-type-gray' | '404-error' | '404-error-gray' | '403-error' | '403-error-gray' | null;
