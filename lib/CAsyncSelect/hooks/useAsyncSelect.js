...
exports.useCAsyncSelect = void 0;
var tslib_1 = require("tslib");
var ahooks_1 = require("ahooks");
var lodash_es_1 = require("lodash-es");
var react_1 = require("react");
var util_1 = require("../util");
var useScrollLoad_1 = require("./useScrollLoad");
var useCAsyncSelect = function (props) {
    ...
    //存储searchWord的state
    var _h = tslib_1.__read((0, react_1.useState)(''), 2), searchWord = _h[0], setSearchWord = _h[1];
    var _j = tslib_1.__read((0, react_1.useState)(), 2), autoLoadFirstValue = _j[0], setAutoLoadFirstValue = _j[1];
    var _k = tslib_1.__read((0, react_1.useState)(true), 2), isFirstInitOptionsHandle = _k[0], setIsFirstInitOptionsHandle = _k[1];
    var _l = tslib_1.__read((0, react_1.useState)(false), 2), autoLoadFirstFlag = _l[0], setAutoLoadFirstFlag = _l[1];
    var cacheDataRef = (0, react_1.useRef)(true);
    var compatibleSearch = showSearch === undefined ? enableSearch : showSearch;
    //useInfiniteScroll函数的调用主体
    var _m = (0, ahooks_1.useInfiniteScroll)(function (d) { return tslib_1.__awaiter(void 0, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
    ...
    var onSearch = (0, react_1.useCallback)((0, lodash_es_1.debounce)(function (value, reason) {
        if (reason !== 'manual')
            return;
        if (!compatibleSearch)
            return;
    ...
    var clearSearchWord = (0, react_1.useCallback)(function () {
        setSearchWord('');
    }, []);
    var clearAutoLoadFirstValue = (0, react_1.useCallback)(function () {
        setAutoLoadFirstValue(undefined);
    }, []);
    // 滚动加载
    var popupScrollHandler = (0, useScrollLoad_1.useScrollLoad)({
        cb: enableRollingLoad ? loadMore : function () { },
        disabled: noMore,
        debounceTime: loadDebounceTime,
    });
    var handleDataAboutPage = function (d) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mergeOption = d.list;
                    if (initOptions) {
                        mergeOption = (0, util_1.mergeOptions)(initOptions, mergeOption);
                    }
                ...
                case 1:
                    ...
                    if (initData.list[0] && typeof initData.list[0] !== 'string' && typeof initData.list[0] !== 'number') {
                        initData.list[0].extra = tslib_1.__assign(tslib_1.__assign({}, initData.list[0].extra), { 'select-fetchInitData': true });
                    }
                    mergeOption = (0, util_1.mergeOptions)(initData.list, mergeOption);
                    _a.label = 2;
                case 2:
                    if (dataSource) {
                        mergeOption = (0, util_1.mergeOptions)(dataSource.list, mergeOption);
                    }
                    d.list = mergeOption;
                    mutate(tslib_1.__assign({}, d));
                    //autoLoad（是否自动加载下拉框）、ifAutoLoadFirst（是否自动选择第一个）都设置为true之后，第一个可以选择的值
                    if (autoLoad && ifAutoLoadFirst && !autoLoadFirstFlag) {
                        setAutoLoadFirstValue((0, util_1.getAutoLoadFirstValue)(d === null || d === void 0 ? void 0 : d.list, mode));
...
exports.useCAsyncSelect = useCAsyncSelect;
