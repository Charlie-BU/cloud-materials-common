...
var Row = /** @class */ (function () {
    ...
    Row.prototype.initDataFromConfig = function () {
        ...
        // }
        this.cells = table.columns.map(function (column) { return new Cell_1.Cell(table, column, _this); });
    };
    Row.prototype.makeObservable = function () {
        (0, reactive_1.define)(this, {
            innerState: reactive_1.observable,
            selectable: reactive_1.observable.computed,
            isExpanded: reactive_1.observable,
            expandable: reactive_1.observable.computed,
            isEditing: reactive_1.observable,
            data: reactive_1.observable,
            cells: reactive_1.observable,
            ...
            isSelected: reactive_1.observable.computed,
            // setComponent: action,
            ...
            setSelect: reactive_1.action,
            setSelectable: reactive_1.action,
            setExpand: reactive_1.action,
            setExpandable: reactive_1.action,
        });
    };
    Row.prototype.onInit = function () {
        this.initialized = true;
        this.table.notify(types_1.LifeCycleTypes.ON_ROW_INIT, { row: this });
    };
    ...
    Row.prototype.setSelect = function (isSelected, options) {
        ...
        var triggerEvent = function () {
            if (options.triggerSelectRowEvent === true) {
                _this.table.notify(types_1.LifeCycleTypes.ON_ROW_SELECT, { row: _this });
                _this.table.notify(types_1.LifeCycleTypes.ON_TABLE_SELECT_ROW);
            }
        };
