...
exports.getAlignRightWidth = exports.getHeaderWidthInfo = void 0;
...
var getHeaderWidthInfo = function (column) {
...
exports.getHeaderWidthInfo = getHeaderWidthInfo;
// 获取 cell 内的数字右对齐时，让开的 icon 部分的宽度
var getAlignRightWidth = function (column) {
    // 减去 padding 是因为 cell 自己也有 padding，不需要让开这部分宽度
    return (0, exports.getHeaderWidthInfo)(column).rightWidth - padding;
};
exports.getAlignRightWidth = getAlignRightWidth;
