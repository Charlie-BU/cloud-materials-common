...
var raceConditionResolver_1 = require("../plugin/raceConditionResolver");
var usePolling = function (options) {
    var _a;
    var table = options.table;
    var polling = table.config.polling;
    // 连续请求失败的次数
    var errorCountRef = (0, react_1.useRef)(0);
    ...
    var _b = (0, ahooks_1.useRequest)(function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            (_a = table
                ...
                // refresh触发来源
                taskPriority: raceConditionResolver_1.TaskPriority.LOW,
                isPooling: true,
