...
exports.useCollapse = exports.STATUS = void 0;
...
function useCollapse(props) {
    ...
    var _a = tslib_1.__read((0, react_1.useState)(false), 2), showOpt = _a[0], setShowOpt = _a[1];
    var _b = tslib_1.__read((0, react_1.useState)(defaultSliceIndex), 2), sliceIndex = _b[0], setSliceIndex = _b[1];
    var _c = tslib_1.__read((0, react_1.useState)(STATUS.INIT), 2), status = _c[0], setStatus = _c[1];
    var _d = tslib_1.__read((0, react_1.useState)(false), 2), expand = _d[0], setExpand = _d[1];
    // 初步计算出截断位置
