        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    pageNumber = (0, lodash_es_1.clamp)(currentPage, startPageNumber, maxPageNumber);
                    offset = (pageNumber - startPageNumber) * pageSize;
                    return [4 /*yield*/, fetcher(tslib_1.__assign(tslib_1.__assign({}, fetcherOptions), { currentPage: pageNumber, offset: offset }))];
                case 2:
                    res_1 = _a.sent();
                    return [2 /*return*/, {
                            fetcherResp: res_1,
