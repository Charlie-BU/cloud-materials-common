...
exports.Table = exports.DefaultStartPageNumber = void 0;
...
exports.DefaultStartPageNumber = 1;
...
var Table = /** @class */ (function () {
    function Table(config) {
        ...
        this.mitt = (0, mitt_1.mitt)();
        // plugin 暂时绑定在 table 实例级别，从而允许在在 plugin 中操作对应的 table
        this.plugin = new plugin_1.Plugin(this);
        this.plugin.init();
    ...
    Table.prototype.fixColumns = function (config) {
        ...
        var fixedColumns = validColumns.map(function (c) {
            var newConfig = tslib_1.__assign({}, c);
            ...
            var fixColumnConfig = function (config) {
                var copiedConfig = tslib_1.__assign({}, config);
                Object.keys(copiedConfig).forEach(function (key) {
                    if (Column_1.CanBeStringColumnConfig.includes(key) && (0, shared_2.isStr)(copiedConfig[key])) {
            ...
            //   });
            // }
            return (0, lodash_es_1.merge)({}, fixColumnConfig(config.globalColumnConfig), fixColumnConfig(newConfig));
        });
        return fixedColumns;
    };
    Object.defineProperty(Table.prototype, "config", {
        ...
        set: function (config) {
            ...
            this._innerConfig = tslib_1.__assign(tslib_1.__assign({}, config), { columns: this.fixColumns(config) });
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(Table.prototype, "sumRowData", {
        get: function () {
            ...
            this.columns.forEach(function (c) {
                ...
                if (computedFn) {
                    hasSummary = true;
                    (0, shared_2.setCellData)(sumRowData, c.config.dataIndex, computedFn({ rows: _this.rows, column: c, table: _this }));
                }
            });
    ...
    Object.defineProperty(Table.prototype, "filterValues", {
        ...
        get: function () {
            var _a;
            return tslib_1.__assign(tslib_1.__assign({}, this.columnFilterValues), (_a = this.toolbar) === null || _a === void 0 ? void 0 : _a.filterValues);
        },
        enumerable: false,
        configurable: true
    });
        ...
        get: function () {
            ...
            this.selectedRowKeys.forEach(function (key) {
                if (_this.dataMap[key] !== undefined) {
                    ...
                    data.push((0, reactive_1.toJS)(_this.dataMap[key]));
                }
            });
            return data;
        },
    ...
    Object.defineProperty(Table.prototype, "columnsAutoWidth", {
        get: function () {
            return (0, shared_1.getAutoWidth)(this);
        },
        enumerable: false,
        configurable: true
    });
    Table.prototype.initDataFromConfig = function () {
        ...
        this.startPageNumber = (_a = config.startPageNumber) !== null && _a !== void 0 ? _a : exports.DefaultStartPageNumber;
    ...
    Table.prototype.initTableStatus = function () {
        ...
        if (tableInitStatus.pageSize !== undefined) {
            ...
            this.pageSize =
                (0, lodash_es_1.isInteger)(tableInitStatus.pageSize) && tableInitStatus.pageSize > 0 ? tableInitStatus.pageSize : 10;
        }
        if (tableInitStatus.currentPage !== undefined) {
            // currentPage 只要是合法数字就行，兜底值 1
            this.currentPage =
                (0, lodash_es_1.isInteger)(tableInitStatus.currentPage) && tableInitStatus.currentPage > 0
    ...
    Table.prototype.makeObservable = function () {
        ...
        var privateAction = {
            makeRows: reactive_1.action,
            fetchData: reactive_1.action,
            toggleData: reactive_1.action,
            toggleLoadMoreData: reactive_1.action,
            setComponentConfig: reactive_1.action,
        };
        (0, reactive_1.define)(this, tslib_1.__assign(tslib_1.__assign({ 
            // Todo observable 默认代表 observable.deep
            // 验证 columns、rows 的劫持是否重复
            // 查看源码得知：对于非 object 类型，observable.ref 和 observable 没有区别
            status: reactive_1.observable, pageSize: reactive_1.observable, total: reactive_1.observable, width: reactive_1.observable, globalScope: reactive_1.observable, 
            // libTableComponentProps: observable,
            // componentType: observable,
            // componentProps: observable,
            // decoratorType: observable,
            // decoratorProps: observable,
            columns: reactive_1.observable, initTotalData: reactive_1.observable.shallow, rows: reactive_1.observable.shallow, rowMap: reactive_1.observable.shallow, cachedSelectedRowKeys: reactive_1.observable, loading: reactive_1.observable.computed, 
            // component: observable.computed,
            // decorator: observable.computed,
            sumRowData: reactive_1.observable.computed, filterValues: reactive_1.observable.computed, columnFilterValues: reactive_1.observable.computed, sorterValues: reactive_1.observable.computed, selectedRowKeys: reactive_1.observable.computed, selectedRowData: reactive_1.observable.computed, 
            // 2023-11-20 更新，将 dataMap 变为 observable.shallow，修复 dataMap 改变了，但是 selectedRowData 没有重新计算的问题
            dataMap: reactive_1.observable.shallow, columnsAutoWidth: reactive_1.observable.computed }, privateAction), { 
            // setComponent: action,
            // setComponentProps: action,
            // setDecorator: action,
            // setDecoratorProps: action,
            setData: reactive_1.action, toggleLoading: reactive_1.action, setGlobalScope: reactive_1.action, reset: reactive_1.action, initData: reactive_1.action, loadMoreData: reactive_1.action, addColumn: reactive_1.action, refresh: reactive_1.action, changePage: reactive_1.action, sort: reactive_1.action, filter: reactive_1.action, expendRow: reactive_1.action, toggleColumns: reactive_1.action, selectRow: reactive_1.action, selectRowAll: reactive_1.action, dragRow: reactive_1.action, deleteRow: reactive_1.action, addRow: reactive_1.action, addRows: reactive_1.action, setWidth: reactive_1.action, clearSelectedRow: reactive_1.action }));
    };
    ...
    Table.prototype.runEffects = function (config) {
        ...
        var effects = (0, shared_1.runEffects)(this, config.effects);
    ...
    Table.prototype.onInitConfig = function () {
        this.notify(types_1.LifeCycleTypes.ON_TABLE_INIT_CONFIG);
    };
    Table.prototype.onInitColumn = function () {
        this.notify(types_1.LifeCycleTypes.ON_TABLE_INIT_COLUMN);
    };
    Table.prototype.onInit = function () {
        this.status.initialized = true;
        this.notify(types_1.LifeCycleTypes.ON_TABLE_INIT);
    };
    ...
    Table.prototype.isRemoteMode = function () {
        ...
        return this.config.mode === types_1.TableMode.REMOTE;
    };
    Table.prototype.isLoadMoreMode = function () {
        return this.config.mode === types_1.TableMode.LOAD_MORE;
    };
    Table.prototype.isLocalMode = function () {
        return this.config.mode === types_1.TableMode.LOCAL;
    };
    ...
    Table.prototype.makeRows = function (data, options) {
        ...
        this.rows = tslib_1.__spreadArray([], tslib_1.__read(this.rows), false);
        data.forEach(function (item, index) {
            var rowKey = (0, shared_2.genRowKey)(item, _this.getOffsetIndexInAllData(index), _this.config.rowKey);
        ...
        this.notify(types_1.LifeCycleTypes.ON_TABLE_UPDATE_ROW_END);
    };
    ...
    Table.prototype.cacheData = function (data, currentPage) {
        var _this = this;
        data.forEach(function (item, index) {
            var rowKey = (0, shared_2.genRowKey)(item, 
    ...
    Table.prototype.diffCachedRowKeySafe = function () {
        ...
        if (this.isLocalMode()) {
            ...
            var currentRowKeys_1 = this.initTotalData.map(function (item, index) {
                return (0, shared_2.genRowKey)(item, _this.getOffsetIndexInAllData(index, _this.startPageNumber), _this.config.rowKey);
            });
            (0, lodash_es_1.remove)(this.cachedSelectedRowKeys, function (key) { return !currentRowKeys_1.includes(key); });
        }
    };
    Table.prototype.tryClearCachedRowKey = function (action) {
         ...
         */
        if (this.isRemoteMode() && rowSelection.preserveCrossPageKeys !== true && action === types_1.FetchTypes.CHANGE_PAGE) {
            this.cachedSelectedRowKeys = [];
        }
    };
    Table.prototype.toggleData = function (options) {
        var _a, _b, _c;
        this.notify(types_1.LifeCycleTypes.ON_TABLE_UPDATE_DATA_START, { isFullUpdate: (_a = options.isFullUpdate) !== null && _a !== void 0 ? _a : true });
        ...
        this.notify(types_1.LifeCycleTypes.ON_TABLE_UPDATE_DATA_END, {
    ...
    Table.prototype.toggleLoadMoreData = function (options) {
        ...
        if (shouldClearData) {
            ...
            // 追加数据
            (_a = this.totalData).push.apply(_a, tslib_1.__spreadArray([], tslib_1.__read(options.data), false));
        }
        ...
        this.notify(types_1.LifeCycleTypes.ON_TABLE_UPDATE_DATA_END, { type: types_1.FetchTypes.LOAD_MORE });
    ...
    Table.prototype.toggleLoading = function (options) {
        ...
        if (options.loading === true) {
            if (this.status.statusChangeReason === types_1.StatusChangeReason.LOAD_MORE) {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        mergedOptions = tslib_1.__assign(tslib_1.__assign({ table: this, pageSize: this.pageSize, offset: (currentPage - this.startPageNumber) * this.pageSize }, options), { currentPage: currentPage, filterValues: this.filterValues, sorterValues: this.sorterValues });
                    ...
                    case 1:
                        _b.trys.push([1, 5, , 6]);
                        if (!(mergedOptions.type === types_1.FetchTypes.INIT)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.runBeforeInitHook()];
                    case 2:
                        _b.sent();
                        _b.label = 3;
                    case 3:
                        this.notify(types_1.LifeCycleTypes.ON_FETCH_START, { fetcherOptions: mergedOptions });
                        ...
                        return [4 /*yield*/, (0, shared_1.runFetcher)({
                    ...
                    case 5:
                        _error_1 = _b.sent();
                        // 开启竞态有高优任务执行
                        if ((0, storage_utils_safe_race_1.isPromiseDiscardedError)(_error_1)) {
                            return [2 /*return*/];
                        }
                        /**
                        ...
                        this.notify(types_1.LifeCycleTypes.ON_FETCH_ERROR, { fetcherOptions: mergedOptions, error: error });
                        this.toggleLoading({ loading: false });
                        return [2 /*return*/];
                    case 6:
                        this.notify(types_1.LifeCycleTypes.ON_FETCH_END, { fetcherOptions: mergedOptions });
    ...
    Table.prototype.addColumn = function (c) {
        ...
        // );
        var column = new Column_1.Column(this, c);
        // if (c.children) {
        //   column.children = [];
        //   c.children.forEach(child => {
        //     if (child) {
    ...
    Table.prototype.refresh = function (options) {
        ...
        if (this.config.fetcher) {
            ...
            return this.fetchData({
                type: types_1.FetchTypes.REFRESH,
    ...
    Table.prototype.loadMoreData = function () {
        this.fetchData({
            type: types_1.FetchTypes.LOAD_MORE,
            currentPage: this.currentPage + 1,
        });
    };
    Table.prototype.changePage = function (pageNumber, pageSize) {
        var _this = this;
        this.notify(types_1.LifeCycleTypes.ON_TABLE_PAGE_CHANGE_START);
        if (pageSize !== undefined && this.pageSize !== pageSize) {
            this.pageSize = pageSize;
        }
        if (this.shouldUseFetcher()) {
            return this.fetchData({
                type: types_1.FetchTypes.CHANGE_PAGE,
                currentPage: pageNumber,
            }).then(function () {
                if (!_this.status.error) {
                    _this.notify(types_1.LifeCycleTypes.ON_TABLE_PAGE_CHANGE_END);
                }
            });
        }
        this.toggleData({
        ...
        this.notify(types_1.LifeCycleTypes.ON_TABLE_PAGE_CHANGE_END);
    };
                ...
                if (filterFn_1) {
                    filterFns.push(function (rowData) {
                        return filterFn_1({
                            ...
                            cellData: (0, shared_2.getCellData)(rowData, c.config.dataIndex),
                            rowData: rowData,
                            column: c,
                            table: _this,
                        });
    ...
    Table.prototype.filterAndSortData = function (data) {
        ...
        var resultData = tslib_1.__spreadArray([], tslib_1.__read(data), false);
        ...
        if (sorterInfos.length > 0) {
            ...
            resultData = tslib_1.__spreadArray([], tslib_1.__read(resultData), false);
            ...
            sorterInfos.forEach(function (_a) {
                ...
                resultData = resultData.sort(function (a, b) {
                    return sorterFn(sorterValue, (0, shared_2.getCellData)(a, dataIndex), (0, shared_2.getCellData)(b, dataIndex));
                });
            });
        }
        return resultData;
    ...
    Table.prototype.sort = function (sorterValues) {
        ...
        this.notify(types_1.LifeCycleTypes.ON_SORT_VALUE_CHANGE);
        if (this.shouldUseFetcher()) {
            return this.fetchData({
                type: types_1.FetchTypes.SORT,
                // 重新排序后，默认切换到第一页
                currentPage: this.startPageNumber,
            });
        }
        this.handleLocalData({ type: types_1.FetchTypes.SORT });
    };
    ...
    Table.prototype.filter = function (filterValues) {
        ...
        this.notify(types_1.LifeCycleTypes.ON_COLUMN_FILTER_VALUE_CHANGE);
        if (this.shouldUseFetcher()) {
            return this.fetchData({
                type: types_1.FetchTypes.FILTER,
                // 触发搜索时，默认切换到第一页
                currentPage: this.startPageNumber,
            });
        }
        this.handleLocalData({ type: types_1.FetchTypes.FILTER });
    };
    ...
    Table.prototype.triggerSelectRowEvent = function (originalSelectedRowKeys) {
        ...
        this.rows.forEach(function (row) {
            ...
            if (originalSelectedRowKeys.includes(row.key) !== _this.cachedSelectedRowKeys.includes(row.key)) {
                _this.notify(types_1.LifeCycleTypes.ON_ROW_SELECT, { row: row });
            }
        });
        this.notify(types_1.LifeCycleTypes.ON_TABLE_SELECT_ROW);
    };
    Table.prototype.selectRow = function (rowKeys, options) {
        if (options === void 0) { options = {}; }
        var originalSelectedRowKeys = tslib_1.__spreadArray([], tslib_1.__read(this.cachedSelectedRowKeys), false);
        this.cachedSelectedRowKeys =
            // 默认会覆写选中过的行，相当于清空选中状态，再设置
            options.overwrite !== false ? rowKeys : Array.from(new Set(tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(originalSelectedRowKeys), false), tslib_1.__read(rowKeys), false)));
    ...
    Table.prototype.selectRowAll = function (selected, options) {
        ...
        var originalSelectedRowKeys = tslib_1.__spreadArray([], tslib_1.__read(this.cachedSelectedRowKeys), false);
        (0, lodash_es_1.remove)(this.cachedSelectedRowKeys, function (key) { return canControlRowKeys.includes(key); });
        if (options.triggerSelectRowEvent === true) {
            this.triggerSelectRowEvent(originalSelectedRowKeys);
        }
    };
    ...
    Table.prototype.addRow = function (data, option) {
        ...
        var newInitTotalData = tslib_1.__spreadArray([], tslib_1.__read(this.initTotalData), false);
        if (option && (0, lodash_es_1.isNumber)(option === null || option === void 0 ? void 0 : option.index)) {
    ...
    Table.prototype.deleteRow = function (rowKey) {
        ...
        var removedRows = (0, lodash_es_1.remove)(newInitTotalData, function (item, index) {
            var curRowKey = (0, shared_2.genRowKey)(item, _this.getOffsetIndexInAllData(index), _this.config.rowKey);
