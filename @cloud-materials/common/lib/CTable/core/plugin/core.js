...
var Plugin = /** @class */ (function () {
    ...
    Plugin.prototype.getMergedPluginContent = function (source, incomingPlugin) {
        ...
        if ((0, shared_1.isStr)(incomingPlugin)) {
            return source[incomingPlugin] || {};
        }
        return (0, lodash_es_1.merge)({}, source[incomingPlugin.type], incomingPlugin);
    };
    Plugin.prototype.init = function () {
        var _this = this;
        globalPlugin.forEach(function (_a) {
            var _b = tslib_1.__read(_a, 2), pluginName = _b[0], plugin = _b[1];
    ...
    Plugin.prototype.getSorter = function (sorter) {
        sorter = (0, shared_1.isFn)(sorter) ? { sorterFn: sorter } : sorter;
        ...
        if (sorter) {
            return tslib_1.__assign({ directions: ['ascend', 'descend'] }, mergedPluginContent);
        }
