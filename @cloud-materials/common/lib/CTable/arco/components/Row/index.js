...
exports.TableRow = exports.TableRowMemo = void 0;
...
var renderRow = function (options, className, children) {
    ...
    var _b = (0, utils_1.getRowDataCy)(row, prefix), dataCy = _b.dataCy, dataCyIdx = _b.dataCyIdx;
    // 为了在 Table Row hover 时, 内置组件的编辑icon、复制icon能够显示出来，需要加个class
    var trPrefix = "".concat(prefix, "-row");
    if (!Component) {
        return (react_1.default.createElement("tr", { "data-testid": dataCy, "data-cy": dataCy, "data-cy-idx": dataCyIdx, className: (0, classnames_1.default)(className, trPrefix) }, children));
    }
    ...
    react_1.default.createElement(Component, tslib_1.__assign({}, defaultComponentProps, componentProps, modelProps, { dataCy: dataCy, dataCyIdx: dataCyIdx }), children));
};
exports.TableRowMemo = (0, react_1.memo)(function (_a) {
    var children = _a.children, index = _a.index, className = _a.className;
    return (react_1.default.createElement(react_3.RowProviderWithoutObserver, { index: index }, function (options) {
        return (0, react_3.renderDecorator)(options.table, renderRow(options, className, children), {
            scope: 'row',
    ...
    var valueEq = (0, lodash_es_1.isEqual)(prev.record.data, next.record.data);
    return valueEq && isSelectedEq && isSelectableEq && isEditingEq && isExpandedEq && isExpandableEq;
});
exports.TableRow = (0, react_2.observer)(function (_a) {
    var children = _a.children, index = _a.index, className = _a.className;
    return (react_1.default.createElement(react_3.RowProvider, { index: index }, function (options) {
        return (0, react_3.renderDecorator)(options.table, renderRow(options, className, children), {
            scope: 'row',
            decoratorType: options.row.decoratorType,
            decoratorProps: options.row.decoratorProps,
