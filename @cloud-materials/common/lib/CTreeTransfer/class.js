...
exports.TreeTransferHelper = void 0;
...
var TreeTransferHelper = /** @class */ (function () {
    function TreeTransferHelper() {
        ...
        this.setGetDataLoading = function (loadingKey, isLoading) {
            var _a;
            _this.loadingMap = tslib_1.__assign(tslib_1.__assign({}, _this.loadingMap), (_a = {}, _a[loadingKey] = isLoading, _a));
        };
...
exports.TreeTransferHelper = TreeTransferHelper;
