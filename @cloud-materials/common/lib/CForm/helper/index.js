...
exports.checkArrayDuplicates = exports.getBrotherField = exports.getParentField = exports.createHelper = exports.Helper = void 0;
var tslib_1 = require("tslib");
var lodash_es_1 = require("lodash-es");
var effect_1 = tslib_1.__importStar(require("./effect"));
var utils_1 = require("./utils");
Object.defineProperty(exports, "getBrotherField", { enumerable: true, get: function () { return utils_1.getBrotherField; } });
Object.defineProperty(exports, "getParentField", { enumerable: true, get: function () { return utils_1.getParentField; } });
Object.defineProperty(exports, "checkArrayDuplicates", { enumerable: true, get: function () { return utils_1.checkArrayDuplicates; } });
...
var _defaultSelectFirstChecker = function (currentValue, dataSource, dataKey) {
    return (0, lodash_es_1.isNil)(currentValue) || !dataSource.some(function (item) { return (0, lodash_es_1.isEqual)((0, lodash_es_1.get)(item, dataKey), currentValue); });
};
var _fieldDepValuesHandle = function (resultHandle, checker) {
    return (function (params) {
        ...
        if ((0, lodash_es_1.isUndefined)(checker)) {
            checker = function (depValues) {
                var depValue = (0, lodash_es_1.values)(depValues)[0];
                return !(0, lodash_es_1.identity)((0, lodash_es_1.isObject)(depValue) ? depValue === null || depValue === void 0 ? void 0 : depValue.value : depValue);
            };
        }
        if (!(0, lodash_es_1.isFunction)(checker)) {
            return (0, effect_1.logWarn)("checker on ".concat(currField.address, " is not a valid function"));
        }
...
var Helper = /** @class */ (function () {
    function Helper(config) {
        ...
        this.selectFirstByDataSource = function (config) {
            var _a, _b;
            return _this.setValueByDataSource(tslib_1.__assign(tslib_1.__assign({}, config), { checker: (_a = config === null || config === void 0 ? void 0 : config.checker) !== null && _a !== void 0 ? _a : _defaultSelectFirstChecker, pathKey: "[0].".concat((_b = config === null || config === void 0 ? void 0 : config.dataKey) !== null && _b !== void 0 ? _b : 'value') }));
        };
        this.fieldCallback = {
        ...
        this.effects = new effect_1.default(config);
    }
    /**
    ...
    Helper.prototype.setDataSource = function (config) {
        return (function (_a) {
            ...
            var dataSource = fetchResultSourceKey ? (0, lodash_es_1.get)(fetchResult, fetchResultSourceKey) : fetchResult;
            if (depValuesSourceKey) {
                dataSource = (0, lodash_es_1.get)(depValues, depValuesSourceKey);
            }
            if (!(0, lodash_es_1.isArray)(dataSource)) {
                return (0, effect_1.logWarn)("dataSource is not a valid array value. please check. ");
            }
    ...
    Helper.prototype.setValueByDataSource = function (config) {
        var pathKey = config.pathKey, checker = config.checker, _a = config.validFilter, validFilter = _a === void 0 ? lodash_es_1.identity : _a, _b = config.dataKey, dataKey = _b === void 0 ? pathKey.slice(pathKey.indexOf('.') + 1) : _b;
        return (function (params) {
            var _a;
            var currField = params.currField;
            var dataSource = (0, lodash_es_1.get)(currField, 'dataSource');
            if (!(0, lodash_es_1.isArray)(dataSource)) {
                return (0, effect_1.logWarn)("currField: ".concat(currField.address, " dataSource is not a valid array value. please check. "));
            }
            if (!(0, lodash_es_1.isUndefined)(checker) && !(0, lodash_es_1.isFunction)(checker)) {
                return (0, effect_1.logWarn)("checker on ".concat(currField.address, " is not a valid function"));
            }
            var currentValue = (0, lodash_es_1.get)(currField, 'value');
            var validSource = (_a = validFilter === null || validFilter === void 0 ? void 0 : validFilter(dataSource)) !== null && _a !== void 0 ? _a : dataSource;
            if ((0, lodash_es_1.isUndefined)(checker) || checker(currentValue, validSource, dataKey, params)) {
                currField.value = (0, lodash_es_1.get)(dataSource, pathKey);
            }
        });
    };
    /**
...
var createHelper = function (config) {
    return new Helper(config);
};
exports.createHelper = createHelper;
exports.default = exports.createHelper;
