...
var priceCalculator_1 = require("./utils/priceCalculator");
...
function useMergeValue(props) {
    ...
    var defaultNumConfig = {
        ...
        initialNum: 1,
        numUnit: '',
        num: (0, lodash_es_1.isNumber)(numConfig === null || numConfig === void 0 ? void 0 : numConfig.initialNum) ? Number(numConfig === null || numConfig === void 0 ? void 0 : numConfig.initialNum) : 1,
    };
    var numConfigState = (0, lodash_es_1.merge)(defaultNumConfig, numConfig);
    // 月份配置的合并
    var defaultDurationConfig = {
        showDuration: false,
        initialDuration: 1,
        duration: (0, lodash_es_1.isNumber)(durationConfig === null || durationConfig === void 0 ? void 0 : durationConfig.initialDuration) ? Number(durationConfig === null || durationConfig === void 0 ? void 0 : durationConfig.initialDuration) : 1,
        durationLabel: locale.CFeeCalculator.defaultDurationLable,
        durationOptions: [],
    };
    var durationConfigState = (0, lodash_es_1.merge)(defaultDurationConfig, durationConfig);
    // 管理 当前的数量和时长
    var _a = tslib_1.__read((0, react_1.useState)({
        num: (0, lodash_es_1.isNumber)(value === null || value === void 0 ? void 0 : value.num) ? Number(value === null || value === void 0 ? void 0 : value.num) : numConfigState.initialNum,
        duration: (0, lodash_es_1.isNumber)(value === null || value === void 0 ? void 0 : value.duration) ? Number(value === null || value === void 0 ? void 0 : value.duration) : durationConfigState.initialDuration,
    ...
    var mergedValue = (0, lodash_es_1.isUndefined)(value)
        ? stateValue
...
function useCFeeCalculator(_a) {
    ...
    // 生成竞态安全的 handleData
    var safeHandleData = (0, storage_utils_safe_race_1.useSafeRace)(handleData, {
        enabled: enableRaceCondition,
    });
    // handleData函数是否正在执行中
    var _g = tslib_1.__read((0, react_1.useState)(true), 2), isCalculating = _g[0], setIsCalculating = _g[1];
    // 是否展示 “计算中” 字样
    var showLoading = (0, lodash_es_1.isUndefined)(loading) ? isCalculating : loading;
    // 时长和数量是否受控
    var isControlled = !(0, lodash_es_1.isUndefined)(value);
    // 价格是否受控
    var isPriceControlled = !(0, lodash_es_1.isUndefined)(priceInfo);
    // 保存当前的数量和时长
    var _h = tslib_1.__read(useMergeValue({
        value: value,
        numConfig: numConfig,
        durationConfig: durationConfig,
    }), 4), currentValue = _h[0], setCurrentValue = _h[1], numConfigState = _h[2], durationConfigState = _h[3];
    // 保存handleData函数返回的价格
    var _j = tslib_1.__read((0, react_1.useState)(), 2), handleDataRes = _j[0], setHandleDataRes = _j[1];
    // 保存合并后的价格（最终显示的价格：处理价格的受控/非受控模式，处理默认值的合并）
    var _k = tslib_1.__read((0, react_1.useState)([]), 2), priceInfoArr = _k[0], setPriceInfoArr = _k[1];
    var prevFormValues = (0, react_1.useRef)(formValues);
    // 价格预览配置的合并
    ...
    var handleOnChange = function (newConfig) {
        ...
        // 受控模式 & 非受控模式
        if (!(0, lodash_es_1.isEqual)(mergedValue, currentValue)) {
    ...
    // 调用handleData改变状态
    var getInfo = function (formValues, numConfigState, durationConfigState) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var res, e_1;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    setHandleDataRes((0, lodash_es_1.isArray)(res) ? res : [{}]);
                    _a.label = 3;
    ...
    // 创建唯一的debounce防抖函数
    var timeoutHandle = (0, ahooks_1.useDebounceFn)(function (formValues, numConfigState, durationConfigState) { return getInfo(formValues, numConfigState, durationConfigState); }, { wait: debounceTime });
    ...
    var priceArr = priceInfoArr.map(function (priceInfoItem) {
        var priceDetail = (0, priceCalculator_1.getPrice)({
...
exports.default = useCFeeCalculator;
