...
var Tab = /** @class */ (function () {
    ...
    Tab.prototype.getCurrentTabComponent = function () {
        ...
        if ((_b = this.options) === null || _b === void 0 ? void 0 : _b.render) {
            return (0, shared_1.runCallable)((_c = this.options) === null || _c === void 0 ? void 0 : _c.render, tabRunCallableProps);
        }
        if ((0, lodash_es_1.isFunction)((_d = this.options) === null || _d === void 0 ? void 0 : _d.component)) {
            return (0, shared_1.runCallable)((_e = this.options) === null || _e === void 0 ? void 0 : _e.component, tabRunCallableProps);
        }
        var componentProps = (0, shared_1.runCallable)((_f = this.options) === null || _f === void 0 ? void 0 : _f.componentProps, tabRunCallableProps);
        return (0, shared_1.getComponent)((_g = this.options) === null || _g === void 0 ? void 0 : _g.component, componentProps);
    };
    /**
     * 提示内容组件
     */
    Tab.prototype.getCurrentTabNoticeComponent = function () {
        var _a, _b, _c, _d, _e;
        if ((0, lodash_es_1.isFunction)((_a = this.options) === null || _a === void 0 ? void 0 : _a.noticeComponent)) {
            return (0, shared_1.runCallable)(this.options.noticeComponent, {
                data: (_b = this.detailPage) === null || _b === void 0 ? void 0 : _b.data,
                tab: this,
                detailPage: this.detailPage,
            });
        }
        var noticeComponentProps = (0, shared_1.runCallable)((_c = this.options) === null || _c === void 0 ? void 0 : _c.noticeComponentProps, {
            data: (_d = this.detailPage) === null || _d === void 0 ? void 0 : _d.data,
            tab: this,
            detailPage: this.detailPage,
        });
        return (0, shared_1.getNoticeComponent)((_e = this.options) === null || _e === void 0 ? void 0 : _e.noticeComponent, noticeComponentProps);
    };
    /**
     * tab的可见性
     */
    Tab.prototype.getVisible = function () {
        var _a, _b;
        return (0, shared_1.runCallable)((_a = this.options) === null || _a === void 0 ? void 0 : _a.visible, {
            data: (_b = this.detailPage) === null || _b === void 0 ? void 0 : _b.data,
            tab: this,
            detailPage: this.detailPage,
        });
    ...
    Tab.prototype.getTitle = function () {
        var _a, _b;
        return (0, shared_1.runCallable)((_a = this.options) === null || _a === void 0 ? void 0 : _a.title, {
            data: (_b = this.detailPage) === null || _b === void 0 ? void 0 : _b.data,
            tab: this,
            detailPage: this.detailPage,
        });
    ...
    Tab.prototype.getNoticeComponent = function () {
        var _a, _b;
        return (0, shared_1.runCallable)((_a = this.options) === null || _a === void 0 ? void 0 : _a.noticeComponent, {
            data: (_b = this.detailPage) === null || _b === void 0 ? void 0 : _b.data,
            tab: this,
            detailPage: this.detailPage,
        });
    ...
    Tab.prototype.getNoticeComponentProps = function () {
        var _a, _b;
        return (0, shared_1.runCallable)((_a = this.options) === null || _a === void 0 ? void 0 : _a.noticeComponentProps, {
            data: (_b = this.detailPage) === null || _b === void 0 ? void 0 : _b.data,
            tab: this,
            detailPage: this.detailPage,
        });
