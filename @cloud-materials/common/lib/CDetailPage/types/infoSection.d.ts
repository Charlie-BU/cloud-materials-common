...
export type CallableReactNode<TabData extends ObjRecord, DetailData extends ObjRecord> = ((option: {
    data: DetailData;
    infoSectionListModel: InfoSectionList<TabData, DetailData>;
    tab: Tab<TabData, DetailData>;
    detailPage: DetailPage<DetailData>;
}) => React.ReactNode) | React.ReactNode;
export interface IInfoSectionItemProps<TabData extends ObjRecord, DetailData extends ObjRecord, GlobalScopeType extends ObjRecord = any> extends Omit<ItemProps, 'label' | 'content' | 'children' | 'hidden' | 'visible' | 'extraContent'> {
    /** 标签 */
    label?: CallableReactNode<TabData, DetailData>;
    /** 标签对应的内容 支持通用内置组件 */
    content?: ItemProps['content'] | ((option: {
        data: DetailData;
        infoSectionListModel: InfoSectionList<TabData, DetailData>;
        tab: Tab<TabData, DetailData>;
     ...
     * @defaultValue false
     */
    hidden?: ItemProps['hidden'] | ((option: {
        data: DetailData;
        infoSectionListModel: InfoSectionList<TabData, DetailData>;
        tab: Tab<TabData, DetailData>;
        detailPage: DetailPage<DetailData, GlobalScopeType>;
     ...
     * @defaultValue true
     */
    visible?: ItemProps['visible'] | ((option: {
        data: DetailData;
        infoSectionListModel: InfoSectionList<TabData, DetailData>;
        tab: Tab<TabData, DetailData>;
        detailPage: DetailPage<DetailData, GlobalScopeType>;
    ...
    /** content右侧内容，包含内置组件 */
    extraContent?: ItemProps['extraContent'] | ((option: {
        data: DetailData;
        infoSectionListModel: InfoSectionList<TabData, DetailData>;
        tab: Tab<TabData, DetailData>;
        detailPage: DetailPage<DetailData, GlobalScopeType>;
...
export interface IInfoSectionDataProps<TabData extends ObjRecord, DetailData extends ObjRecord, GlobalScopeType extends ObjRecord = any> extends Pick<CInfoSectionProps, 'moduleEditor' | 'layout' | 'colNumber' | 'labelWidth' | 'className'> {
    /** 支持自动分割或者手动分割 */
    ...
    /** 模块编辑 */
    onModuleEditorClick?: CInfoSectionProps['onModuleEditorClick'] | ((option: {
        data: DetailData;
        infoSectionListModel: InfoSectionList<TabData, DetailData>;
        tab: Tab<TabData, DetailData>;
        detailPage: DetailPage<DetailData, GlobalScopeType>;
 ...
 */
export interface IInfoSectionListProps<TabData extends ObjRecord, DetailData extends ObjRecord, GlobalScopeType extends ObjRecord = any> {
    /** @zh 传入列表数据渲染 */
...
export type DefineInfoSectionListConfig = <TabData extends ObjRecord, DetailData extends ObjRecord, GlobalScopeType extends ObjRecord = any>(config: IInfoSectionListProps<TabData, DetailData, GlobalScopeType>) => IInfoSectionListProps<TabData, DetailData, GlobalScopeType>;
