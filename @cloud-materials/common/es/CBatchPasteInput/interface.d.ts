...
export interface CBatchPasteInputProps extends InputTagProps {
     ...
     */
    onSplit?: (addedValue: CBatchPasteInputValueType[], // 粘贴事件或输入事件新增的标签组
    valueBeforeAdd: CBatchPasteInputValueType[], // 粘贴或输入前 的标签组
    valueAfterAdd: CBatchPasteInputValueType[]) => void;
    /** 透传 Arco.Tag */
    arcoTagProps?: Omit<TagProps, 'closable' | 'onClose'> | ((options: {
        value: CBatchPasteInputValueType;
