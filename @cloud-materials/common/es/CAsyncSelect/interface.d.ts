 ...
 */
export type CAsyncSelectHooksProps = Pick<CAsyncSelectProps, 'fetchData' | 'enableRollingLoad' | 'searchDebounceTime' | 'loadDebounceTime' | 'staleTime' | 'onError' | 'autoLoad' | 'ifAutoLoadFirst' | 'fetchInitData' | 'dataSource' | 'initOptions' | 'mode' | 'onDataSourceChange' | 'showSearch' | 'enableSearch'>;
