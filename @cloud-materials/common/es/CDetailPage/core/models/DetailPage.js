...
var DetailPage = /** @class */ (function () {
    function DetailPage(detailPageConfig) {
        ...
        this.makeObservable();
        this.options = __assign(__assign({}, getInitDetailPageOptions()), detailPageConfig);
    ...
    DetailPage.prototype.getAvailableActiveTabKey = function () {
        ...
        var urlTabKey = getUrlTabKey(this.options.urlTabKeyName);
    ...
    DetailPage.prototype.getDetailHeaderProps = function () {
        return __assign({ needRefreshBtn: true, title: '' }, runCallable(this.options.cDetailPageHeaderProps, {
            data: this.data,
            detailPage: this,
        }));
    };
    DetailPage.prototype.getDetailPageContentProps = function () {
        var _a;
        return runCallable((_a = this.options) === null || _a === void 0 ? void 0 : _a.cDetailPageContentProps, {
            data: this.data,
            detailPage: this,
        });
    };
    ...
    DetailPage.prototype.getGlobalErrorConfig = function () {
        var _a;
        return runCallable((_a = this.options) === null || _a === void 0 ? void 0 : _a.globalErrorConfig, {
            data: this.data,
            detailPage: this,
        });
    };
    ...
    DetailPage.prototype.getNeedTabPane = function () {
        var _a;
        return runCallable((_a = this.options) === null || _a === void 0 ? void 0 : _a.needTabPane, {
            data: this.data,
            detailPage: this,
        });
    };
    DetailPage.prototype.getNeedLoading = function () {
        var _a;
        return runCallable((_a = this.options) === null || _a === void 0 ? void 0 : _a.needLoading, {
            data: this.data,
            detailPage: this,
        });
    };
    ...
    DetailPage.prototype.initTabsFromOptions = function (options) {
        ...
        // 首先清空tabs数组
        this.clearTabs();
        var optionTabs = runCallable((_a = this.options) === null || _a === void 0 ? void 0 : _a.tabs, {
            data: this.data,
            detailPage: this,
        });
        optionTabs === null || optionTabs === void 0 ? void 0 : optionTabs.map(function (tabItem) {
            var tab = runCallable(tabItem, {
                data: _this.data,
                tab: '',
                detailPage: _this,
            });
            tab = __assign({ visible: true }, tab);
            _this.tabs.push(new Tab(_this, tab));
        });
        if (!initPlaceholder) {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (((_a = this.options.extraConfig) === null || _a === void 0 ? void 0 : _a.clearGlobalScopeInFetcher) === false) {
                            this.globalScope = __assign(__assign({}, this.globalScope), res === null || res === void 0 ? void 0 : res.globalScope);
                        }
                        else {
    ...
    DetailPage.prototype.init = function (options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                this._refresh(__assign({ reset: true, isFirstRender: true, resetActiveTab: (_a = this.options) === null || _a === void 0 ? void 0 : _a.resetActiveTab }, (options !== null && options !== void 0 ? options : {})));
                return [2 /*return*/];
            });
        });
    };
