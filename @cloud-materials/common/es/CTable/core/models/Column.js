...
export var CanBeStringColumnConfig = ['formatter', 'sorter', 'filter', 'summary', 'autoWidth'];
var Column = /** @class */ (function () {
    ...
    Object.defineProperty(Column.prototype, "filterDataSource", {
        ...
        get: function () {
            ...
            if (dataSource === 'auto') {
                var uniqueValues = Array.from(new Set(this.table.initTotalData.map(function (item) { return getCellData(item, _this.config.dataIndex); })));
    ...
    Column.prototype.makeObservable = function () {
        ...
        define(this, __assign({ title: observable, width: observable, visible: observable, hidden: observable, show: observable.computed, 
            ...
            filterValue: observable, sorterValue: observable, filterVisible: observable, 
            // filterComponent: observable.computed,
            // filterDecorator: observable.computed,
            // filterIconComponent: observable.computed,
            filterDataSource: observable.computed, setVisible: action, setHidden: action, setFilterValue: action, setSorterValue: action, setFilterVisible: action, setWidth: action, setTitle: action }, privateAction));
    };
