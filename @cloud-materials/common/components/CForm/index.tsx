import {
  CFormDefaultComponentProps as FormDefaultComponentProps,
  CFormDefaultDecoratorProps as FormDefaultDecoratorProps,
  DefaultBuiltInComponentMap,
} from './const';
import ConfigForm from './react/CConfigForm';

export const CFormDefaultComponentProps = FormDefaultComponentProps;
export const CFormDefaultDecoratorProps = FormDefaultDecoratorProps;
export const CFormDefaultBuiltInComponentMap = DefaultBuiltInComponentMap;
export { default as DefaultCFormDecorator } from './react/Components/Decorators/DefaultCFormDecorator';

export const CConfigForm = ConfigForm;

const CForm = CConfigForm.registerConfig(CFormDefaultBuiltInComponentMap, {
