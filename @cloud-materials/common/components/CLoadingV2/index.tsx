...
import type { CLoadingV2Props } from './interface';
...
const CLoadingComponent: React.FC<CLoadingV2Props> = props => {
  const {
    style,
    className,
    type = 'inline',
...
const CLoadingV2 = Object.assign(CLoadingComponent, { Spin: CSpin, Result: CResult, displayName: 'CLoadingV2' });
