...
export class InfoSectionItem<TabData extends ObjRecord, DetailData extends ObjRecord> {
  /**
   *  InfoSectionItem的配置
   */
  ...
  constructor(
    options: IInfoSectionItemProps<TabData, DetailData>,
    infoSection: InfoSection<TabData, DetailData>,
    infoSectionList: InfoSectionList<TabData, DetailData>,
  ) {
    this.makeObservable();
