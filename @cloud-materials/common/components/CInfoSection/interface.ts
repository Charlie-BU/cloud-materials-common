 ...
 */
export interface CInfoSectionProps
  extends Pick<
    ItemProps,
    | 'layout'
    | 'itemStyle'
 ...
 */
export interface CInfoSectionData
  extends Pick<
    CInfoSectionProps,
    | 'onModuleEditorClick'
    | 'moduleEditor'
 ...
 */
export interface CInfoSectionListProps
  extends Omit<CInfoSectionProps, 'title' | 'children' | 'editor' | 'onModuleEditorClick' | 'moduleEditor'> {
  /** 传入列表数据渲染 */
